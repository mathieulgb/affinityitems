...
function retrieveConfiguration()
{
	...
	{
		$configuration = formatConfiguration(unserialize(Configuration::get('AE_CONFIGURATION_'.strtoupper($hook).'')), $hook);
		...
		$sql[] = 'INSERT INTO ps_ae_theme(name, configuration) VALUES("'.$hook.'", \''.serialize($theme).'\')';
	}
